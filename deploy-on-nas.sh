...
echo ""
echo "查看日志:"
echo "  sudo docker logs -f ${PROJECT_NAME}"
echo ""
echo "管理命令:"
echo "  停止: sudo docker stop ${PROJECT_NAME}"
echo "  重启: sudo docker restart ${PROJECT_NAME}"
echo "  删除: sudo docker rm -f ${PROJECT_NAME}"
